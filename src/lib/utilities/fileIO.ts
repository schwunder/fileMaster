...
export async function copyToDB(absoluteDirectoryPath: string) {
  try {
    ...
    // Copy matched files, but only if they don't already exist in the destination
    ...
    // Filter out null values (files that weren't copied) and return the list of newly copied .png files
